...
(* OASIS_START *)
(* DO NOT EDIT (digest: a34e014077a732270aad0f9047b2b97d) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Parse"; "Eval"; "Cnf"; "Sat"; "Smt"];
                      lib_pack = false;
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "Q\028\139c\156Ôò\137=ú\0242æcNØ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
