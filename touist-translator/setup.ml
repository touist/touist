...
(* OASIS_START *)
(* DO NOT EDIT (digest: a85f9a305c9a0562e94bb90e0321bbf0) *)
(*
...
let setup_t =
  {
     ...
     build =
       OCamlbuildPlugin.build
         [
            "-use-ocamlfind";
            "-use-menhir -menhir 'menhir --table --inspection -v -la 2' -pkg fileutils,menhirLib,str"
         ];
     test = [];
     doc = [];
               ...
               pre_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("sh", ["generate-version-number.sh"])))
                 ];
               post_command = [(OASISExpr.EBool true, None)]
            };
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "á_XGó÷ã±PA\145,Cß\151>";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
