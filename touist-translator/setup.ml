...
(* OASIS_START *)
(* DO NOT EDIT (digest: abd93e7c28717cc8bd9f194a579aee04) *)
(*
...
let setup_t =
  {
               ...
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "Display trace of the parser when parsing (NO WORKING)";
     ...
     oasis_version = "0.4.7";
     oasis_digest =
       Some "d\225\236\188\234Z\209\003\174\187\137r\236&\024\204";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
