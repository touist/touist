...
public class PalettePanel extends javax.swing.JPanel {
     ...
     */
    public PalettePanel(JTextArea textArea) {
        initComponents();
        ...
        section1.addInsertButton(new InsertionButton(textArea, "Bouton 1", "aide 1"));
        section1.addInsertButton(new InsertionButton(textArea, "Bouton 2", "aide 2"));
        section1.addInsertButton(new InsertionButton(textArea, "Bouton 3", "aide 3"));
        section2.addInsertButton(new InsertionButton(textArea, "Bouton 4", "aide 4"));
        section2.addInsertButton(new InsertionButton(textArea, "Bouton 5", "aide 5"));
