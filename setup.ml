...
(* OASIS_START *)
(* DO NOT EDIT (digest: b99b0b5be3ee16af931661d17b86fbc5) *)
(*
...
let setup_t =
  {
          ...
          description =
            Some
              [
                 ...
                 OASISText.Verbatim "   opam install yices2"
              ];
          tags = [];
          categories = [];
          files_ab = [];
     ...
     oasis_digest = Some "jI_,\143\134\014\157\152h]\226\185\157\171\250";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
