...
(* OASIS_START *)
(* DO NOT EDIT (digest: 62eff4c2b3c66835449432cc277477c9) *)
(*
...
let setup_t =
  {
       ...
       [
          ...
          ("touist_yices2",
            OCamlbuildDocPlugin.doc_build
              {
                 OCamlbuildDocPlugin.extra_args = ["-use-ocamlfind"];
                 run_path = "src/lib/yices2"
              });
          ("touist_qbf",
            OCamlbuildDocPlugin.doc_build
              {
                 OCamlbuildDocPlugin.extra_args = ["-use-ocamlfind"];
                 run_path = "src/lib/qbf"
              });
          ("touist_depqbf",
            OCamlbuildDocPlugin.doc_build
              {
                 OCamlbuildDocPlugin.extra_args = ["-use-ocamlfind"];
                 run_path = "src/lib/qbf/depqbf"
              })
       ];
     ...
     package =
       {
          ...
          license_file = None;
          copyrights = [];
          maintainers = ["Ma\195\171l Valais <mael.valais@gmail.com>"];
          authors =
            ["Ma\195\171l Valais <mael.valais@gmail.com>"; "Olivier Lezaud"];
          homepage = Some "https://www.irit.fr/touist";
          bugreports = None;
          ...
          description =
            Some
              [
                 ...
                 OASISText.Verbatim "Optionnal solvers:";
                 OASISText.Verbatim
                 ...
                 OASISText.Verbatim "  (4) opam reinstall touist"
              ];
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "enable yices2 solver (SMT)";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "enable qbf.quantor solver (QBF)";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "enable qbf.depqbf solver (QBF)";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "enable library install";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("menhirLib",
                               Some (OASISVersion.VGreaterEqual "20151023"));
                           FindlibPackage
                             ("fileutils",
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src/lib/yices2";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "touist";
                           FindlibPackage
                             ("yices2",
                               Some (OASISVersion.VGreaterEqual "0.0.2"))
                        ];
                   ...
                   {
                      lib_modules = ["TouistSmtSolve"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "touist";
                      lib_findlib_name = Some "yices2";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("qbf", Some (OASISVersion.VGreaterEqual "0.1"));
                           FindlibPackage ("qbf.quantor", None);
                           InternalLibrary "touist"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                   ...
                   {
                      lib_modules = ["TouistQbfSolve"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "touist";
                      lib_findlib_name = Some "qbf";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "touist_depqbf";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = "src/lib/qbf/depqbf";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("qbf", Some (OASISVersion.VGreaterEqual "0.1"));
                           FindlibPackage ("qbf.depqbf", None);
                           InternalLibrary "touist";
                           InternalLibrary "touist_qbf"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                   ...
                   {
                      lib_modules = ["TouistDepqbfSolve"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "touist";
                      lib_findlib_name = Some "depqbf";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "touist"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = true; exec_main_is = "touist.ml"});
               Executable
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for the TouIST library";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
                        ...
                        [
                           ...
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "docs",
                                OASISExpr.EFlag "yices2"),
                             true)
                        ];
                      doc_install = [(OASISExpr.EBool true, false)];
                      doc_install_dir = "$htmldir/api";
                      doc_title =
                        "API reference for the touist.yices2 subpackage";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
                  ...
                  },
                   {
                      ...
                      doc_build =
                        [
                           ...
                           (OASISExpr.EFlag "docs", false);
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "docs", OASISExpr.EFlag "qbf"),
                             true)
                        ];
                      doc_install = [(OASISExpr.EBool true, false)];
                      doc_install_dir = "$htmldir/api";
                      doc_title =
                        "API reference for the touist.qbf subpackage";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$htmldir/api";
                      doc_title =
                        "API reference for the touist.depqbf subpackage";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/touist/touist.git";
                      src_repo_browser =
                        Some "https://github.com/touist/touist";
     ...
     oasis_digest = Some "K\022\143\141\177V~\254\018\193\214\027\029]'!";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
