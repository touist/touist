...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1fb99c2084a3f0e8ff564421cef78e07) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
            ...
            [
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "build a .js file that contains linter() and latex()";
                 ...
                 ({
                   ...
                   },
                   {
                      ...
                      lib_internal_modules =
                        ["Lexer"; "Parser"; "Parser_error_report"; "Types"];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src/cli";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "touistLib"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "menhir"];
                      bs_interface_patterns =
                        [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "touistjs.ml"});
               Test
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools = [InternalExecutable "test"]
                   });
               Doc
                 ({
                     cs_name = "touistLib";
          ...
          build_custom =
            {
               pre_command =
                 [(OASISExpr.EBool true, Some (("make", ["pre-build"])))];
               post_command = [(OASISExpr.EBool true, None)]
            };
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "Æ¦Cç8K\0304Ù\024W #\012o}";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
