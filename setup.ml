...
(* OASIS_START *)
(* DO NOT EDIT (digest: 43c2c4f44c60b5b2a1c77ff95ef0f0de) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://touist.github.io";
          bugreports = None;
          ...
          description =
            Some
              [
                 OASISText.Para
                   "The Touist language is a friendly language for writing propositional logic and logic on real and integers (SMT). This language aims to formalize real-life problems (e.g., the sudoku can be solved in a few lines). Touist embeds the minisat solver (for propositional logic) and (coming soon) the SMT2 solver. It can also generate the DIMACS, SMT2 and latex formats from you touist file. NOTE. yices2 cannot be installed using 'opam install yices2', it is 'pin' only. Install it with opam pin add -y yices2 https://github.com/maelvalais/ocamlyices2.git"
              ];
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "enable support for the embeded SMT solver (using yices2)";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "enable installation of the touist library";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_internal_modules =
                        ["Lexer"; "Parser"; "Parser_error_report"];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "touist.ml"});
               Executable
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for the Touist compiler";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_digest = Some "s\228\003\151pr\251\145\251r\012.\205\238\241'";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
