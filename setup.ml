...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0e59f55304fb864b71a6a9e998dca0cb) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "enable quantor  solver (QBF)";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
     ...
     oasis_digest = Some "sN\142\193=E\r%\184\188\024R\2511a5";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
