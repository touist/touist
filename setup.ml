(* OASIS_START *)
(* DO NOT EDIT (digest: 42e104119caebb5626464bf7f8b243fa) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "touistc.ml"});
               Executable
                 ({
                     cs_name = "touistc-debug";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      ...
                      src_repo_tag = None;
                      src_repo_subdir = Some "touist-translator"
                   })
            ];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "zgF\001§l¦ðaD\133¨t\001ßû";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
