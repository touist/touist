...
(* OASIS_START *)
(* DO NOT EDIT (digest: e97691ed8ab5a12382b3df7f84582f8b) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "enable yices2 solver";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "enable quantor  solver";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                  ...
                  },
                   {
                      ...
                      bs_install =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "qbf", OASISExpr.EFlag "lib"),
                             true)
                        ];
                      bs_path = "src/lib/qbf";
                      bs_compiled_object = Best;
     ...
     oasis_digest = Some "\249\026\224\159\155\172\184,W`0\022V&\186\187";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
