...
(* OASIS_START *)
(* DO NOT EDIT (digest: af2efaca055f970b8143826efeca703a) *)
(*
...
let setup_t =
  {
          ...
          description =
            Some
              [
                 ...
                 OASISText.Verbatim "  `opam reinstall touist`";
                 OASISText.Verbatim
     ...
     oasis_digest = Some "\255\246\015\007\151\1278\180\b/K\129C\127\015Z";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
