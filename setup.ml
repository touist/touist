...
(* OASIS_START *)
(* DO NOT EDIT (digest: da93b13853bb5b5771dc4da7b8ede161) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          license_file = None;
          copyrights = [];
          maintainers = ["MaÃ«l Valais <mael.valais@gmail.com>"];
          authors =
            ["MaÃ«l Valais <mael.valais@gmail.com>"; "Olivier Lezaud"];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\150ñÏ\128\146\128GäF4\159âTß]ü";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
