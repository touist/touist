...
(* OASIS_START *)
(* DO NOT EDIT (digest: c4128da25b258648559b9e8965ecb8df) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "Compiles files into DIMACS-CNF format";
          description = None;
          categories = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "lexer"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "test_lexer.ml"});
               Test
                 ({
                     cs_name = "test_lexer";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "BN\149\168r\160`kB: ]p\130\146@";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
