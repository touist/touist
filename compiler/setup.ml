...
(* OASIS_START *)
(* DO NOT EDIT (digest: c6ba1e1e19da078227c612659c5891cf) *)
(*
...
let setup_t =
  {
     ...
     build =
       OCamlbuildPlugin.build
         ["-use-ocamlfind"; "-use-menhir"; "-package"; "fileutils"];
     test = [];
     doc = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\236\012D\\\238\211\175\188\166\225\240\024\012\012\218\029";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
