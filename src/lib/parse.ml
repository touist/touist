...
(** Same for [Parser.Incremental.touist_dlpa] *)
let parse_dlpa ?debug_syntax:(d=false) ?(filename="foo.touistl") text = parse Parser.Incremental.touist_dlpa ~debug:d filename text
